...
class CalendarFirstScreen extends StatelessWidget {
  const CalendarFirstScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Gradient glow — 50px visible from left, 450px visible from top
          Positioned(
            left: -(363 * scaleX - 50),
            top: -(577 * scaleY - 450),
            child: Opacity(
          ...
          // Description text below calendar
          Positioned(
            top: 340,
            left: 40,
            right: 40,
